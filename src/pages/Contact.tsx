        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg font-inter text-white/90 mb-8 leading-relaxed max-w-2xl mx-auto">
              Fill out our membership form to get involved with Wesleyan Entrepreneurs and start your entrepreneurial journey with us.
            </p>
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              aria-label="Fill out membership form to join Wesleyan Entrepreneurs"
            >
